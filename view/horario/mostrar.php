					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="user">
								<ul class="nav nav-collapse">
									<li>
										<a href="../../Meditech/folder/usuarios.php">
											<span class="sub-item">Mostrar</span>
										</a>
									</li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <!-- Include modal for adding new schedule -->
        ...
        <table id="add-row" class="display table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th>Doctor</th> <!-- Nueva columna para el nombre del doctor -->
            ...
            <tfoot>
                <tr>
                    ...
                    <th>Horario</th>
                    <th>Fecha Creación</th>
                    <th>Doctor</th> <!-- Columna de pie de tabla para el doctor -->
                    <th>Acciones</th>
                </tr>
            </tfoot>
            <tbody>
                <?php foreach ($dato as $va) { ?>
                    <tr>
                        <td><?php echo $va['dia']; ?></td> <!-- Día de disponibilidad -->
                        <td><?php echo $va['hora_inicio']; ?> - <?php echo $va['hora_fin']; ?></td> <!-- Horario -->
                        <td><?php echo $va['fecha_creacion']; ?></td> <!-- Fecha de creación -->
                        <td><?php echo $va['nomdoc']; ?></td> <!-- Nombre del doctor -->
                        <td>
