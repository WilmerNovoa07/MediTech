                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group form-group-default">
                                        <label>DNI</label>
                                        <input name="dnipa" type="text" required class="form-control" maxlength="10" placeholder="Ingrese DNI o CC" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                                    </div>
                                </div>
