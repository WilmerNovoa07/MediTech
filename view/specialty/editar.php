<!-- Modal-edit -->
<div class="modal fade" id="editRowModal<?php echo $row['codespe']; ?>" aria-labelledby="myModalLabel" tabindex="-1"
...
<!-- Delete -->
<div class="modal fade" id="deleteRowModal<?php echo $row['codespe']; ?>" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="../view/specialty/BorrarRegistro.php?codespe=<?php echo $row['codespe']; ?>"
