														...
														<tr>
															...
															<td>
																<div class="form-button-action">
																	...
																	<button href="#editRowModal=<?php echo $row['codespe']; ?>"
																		class="btn btn-link btn-primary btn-lg"
																		data-toggle="modal" title=""
																		data-original-title="Edit Task"
																		data-target="#editRowModal<?php echo $row['codespe']; ?>">
																	...
																	<button
																		href="#deleteRowModal=<?php echo $row['codespe']; ?>"
																		class="btn btn-link btn-danger btn-lg"
																		data-toggle="modal" title=""
																		data-original-title="Delete Task"
																		data-target="#deleteRowModal<?php echo $row['codespe']; ?>">
