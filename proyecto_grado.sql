...
--
--
-- Estructura de tabla para la tabla `doctor` con usuario y clave
--
...
--
-- Ejemplo de inserción de datos con usuario y clave
--

INSERT INTO `doctor` (`coddoc`, `dnidoc`, `nomdoc`, `apedoc`, `codespe`, `sexo`, `telefo`, `fechanaci`, `correo`, `naciona`, `usuario`, `clave`, `estado`, `fecha_create`) VALUES
(2, '74747384', 'Manuel', 'Alban', 4, 'Masculino', '998766554', '1995-09-09', 'manuel.alban@example.com', 'Peruana(o)', 'malban', 'b0baee9d279d34fa1dfd71aadb908c3f', '1', '2022-05-02 03:08:38'),
(3, '78493949', 'Jose', 'Martinez Juarez', 3, 'Masculino', '988833333', '2022-03-30', 'jose.martinez@example.com', 'Peruana(o)', 'jmartinez', 'b0baee9d279d34fa1dfd71aadb908c3f', '1', '2022-03-31 01:43:25');

--
-- Actualización de la tabla para añadir los campos si ya existe
--

ALTER TABLE `doctor`
ADD COLUMN `usuario` varchar(15) COLLATE utf8_unicode_ci NOT NULL AFTER `naciona`,
ADD COLUMN `clave` varchar(255) COLLATE utf8_unicode_ci NOT NULL AFTER `usuario`;
